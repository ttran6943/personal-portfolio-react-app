  ...
  return (
    <div className="about-me">
      ...
      <p>
        ...
        developed a passion for coding. I had the privilege at UCLA to use C++
        and Python in various applications, such as simulating kinematic
      ...
      <ul>
        <li>
          Working on software for companies who share a goal of bettering our
          daily lives
        </li>
